...
```python
from dunk_ai.tools.loan_clarity import reducing_balance, flat_rate
...
```python
from dunk_ai.tools.loan_clarity import generate_amortization_schedule
...
```python
from dunk_ai.tools.loan_clarity import calculate_prepayment_impact
...
```python
from dunk_ai.tools.loan_clarity import compare_loans
...
```python
from dunk_ai.tools.loan_clarity import calculate_tax_benefits
...
```python
from dunk_ai.tools.loan_clarity import calculate_loan_eligibility
